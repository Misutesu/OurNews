...
public class WellComeActivity extends BaseActivity {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        mFragments[0] = new WellComeFragment();
        mFragments[1] = new WellComeFragment();
        mFragments[2] = new WellComeFragment();
        mFragments[3] = new WellComeFragment();
        colors[0] = ContextCompat.getColor(this, R.color.colorPrimaryBlue);
        colors[1] = ContextCompat.getColor(this, R.color.colorPrimaryGreenBlack);
        colors[2] = ContextCompat.getColor(this, R.color.colorPrimaryGreen);
        colors[3] = ContextCompat.getColor(this, R.color.colorPrimaryRed);
